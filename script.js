...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const windInfoPanel = document.getElementById('windInfo'), simulateBtn = document.getElementById('simulateBtn');
    ...
    function startSimulation() {
        if (!windData.speed) { alert('Данные о ветре еще не загружены. Подождите.'); return; }
